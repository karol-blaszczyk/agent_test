#!/usr/bin/env python3
"""
Verification script to check version_info_4.py output format and timestamp validity.
"""
...
def verify_version_info_4():
    """Run version_info_4.py and verify its output format."""
    try:
        # Run the version_info_4.py script
        result = subprocess.run(['python', 'version_info_4.py'], 
        ...
        # Parse the timestamp (should be in YYYY-MM-DD HH:MM:SS format)
        try:
            script_time = datetime.strptime(timestamp_line, '%Y-%m-%d %H:%M:%S')
